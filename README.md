...
- **Multiple visual styles**:
  ...
  - **Lines**: Edge outline rendering with enhanced colo
...
## Hand Gestures
<img width="1583" height="903" alt="Screenshot 1" src="Screenshot%201.png" />
<img width="1578" height="932" alt="Screenshot 2" src="Screenshot%202.png" />
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/bivinbooster/MirrorClone.git
   cd MirrorClone
   ```
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/MirrorClone.git
   cd MirrorClone
   ```
...
1. **Create a new method** in the `MirrorClone` class:
   ```python
